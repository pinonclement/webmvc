...
<!--[if gt IE 8]> <!--> <html class="no-js"> <!--<![endif]-->
	...
	<form:form  method="POST">	
		<input type="text" name="name" placeholder="Nom de l'arc..">		    
		<select name="filtre" size="1">
		<OPTION>Date d'ajout</OPTION>
		<OPTION>Duree</OPTION>
		<Option>Sous-titre : Non</Option>
		</select>
		<input type="hidden" id ="scretValue" name="secretValue" value="${lol.videoid}" />
...
<form:form method ="post" action="recherche/gopage" >
<br> Titre :<c:out value="${lol.nom}"/>
<br> Durée :<c:out value="${lol.durée}"/>
<br> Arc :<c:out value="${lol.arc}"/>
<br>
