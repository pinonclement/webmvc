...
<form method="POST"modelAttribute="user" enctype="multipart/form-data">
	 ...
	 <section class="webdesigntuts-workshop">
		 ...
		 <input type="text" name="videoname" placeholder="nom japonais"><br /> <br /> 		    	

	 <section class="webdesigntuts-workshop">
		    
		 <input type="text" name="arc" placeholder="arc"><br /> <br /> 		    	
	
	 <section class="webdesigntuts-workshop">
		    
		 <input type="text" name="duree" placeholder="duree"><br /> <br /> 		    	
	
	 <section class="webdesigntuts-workshop">
		    
		 <input type="text" name="datediffusion" placeholder="date de diffusion AAAA-MM-JJ"><br /> <br /> 		    	

	
		<center><input type="file" name="file"></center>
		 <input type="text" name="name" placeholder="nom.mp4"><br /> <br /> 
